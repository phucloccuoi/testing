...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Cửa hàng trang sức PNJ HP</title>
...
<div class="row">
	<div class="span4">
	<h1>
	<a class="logo" href="index.php"><span>Cửa hàng trang sức PNJ HP</span> 
	...
	<h1 class="dotmark">
	<i class="icon-cut"></i>
	Cửa hàng trang sức PNJ HP xin chào
	</h1>
	</div>
	</div>
	<div class="span4 alignR">
	<p><br> <strong> Support (24/7) :  036 444 8282 </strong><br><br></p>
...
<div class="well">
	<form class="form-horizontal" >
		...
		<div class="control-group">
			<label class="control-label">Type Card <sup>*</sup></label>
			<div class="controls">
			  <input type="text" placeholder=" Field name">
			</div>
		</div>
		...
		<div class="control-group">
			<label class="control-label">CVV Number <sup>*</sup></label>
			<div class="controls">
			  <textarea></textarea>
			</div>
		</div>
...
<div class="well">
	<form class="form-horizontal" >
		...
		<div class="control-group">
			<label class="control-label">Date of Brith <sup>*</sup></label>
			<div class="controls">
			  <input type="text" placeholder=" Field name">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">Organation <sup>*</sup></label>
			<div class="controls">
			  <input type="text" placeholder=" Field name">
			</div>
		</div>
		...
		<div class="control-group">
			<label class="control-label">Address 2 <sup>*</sup></label>
			<div class="controls">
			  <input type="text" placeholder=" Field name">
			</div>
		</div>
		<div class="control-group">
			...
			<label class="control-label">Type Service <sup>*</sup></label>
			<div class="controls">
			  <input type="text" placeholder=" Field name">
			</div>
		</div><div class="control-group">
			<label class="control-label">Hobby <sup>*</sup></label>
			<div class="controls">
			  <input type="text" placeholder=" Field name">
			</div>
		</div><div class="control-group">
			<label class="control-label">Name Accout <sup>*</sup></label>
			<div class="controls">
			  <input type="text" placeholder=" Field name">
			</div>
		</div><div class="control-group">
			...
			<label class="control-label">None <sup>*</sup></label>
			<div class="controls">
			  <input type="text" placeholder=" Field name">
			</div>
		</div><div class="control-group">
...
<a href="#">SUPPLIERS</a> <br/>
 ...
 <div class="span6">
<h5>The standard PNJ of HP</h5>
The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for
 those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et 
 Malorum" by Cicero are also reproduced in their exact original form, 
accompanied by English versions from the 1914 translation by Hoanghait.
 </div>
 </div>
</footer>
</div><!-- /container -->
...
<div class="container">
	...
	<span>Copyright &copy; 2019<br> bootstrap ecommerce shopping PNJ HP template</span>
</div>
</div>
