...
-->
	...
	<div class="row-fluid">
		...
		<h5>
			2202 PhanRang NT.<br/>
			Long An Province, LA 6285<br/><br/>
			ntphat@ittdcmail.tk<br/>
			﻿Tel 036-444-8282<br/>
			Fax 034-904-5987<br/>
			web:www.hoanghait.tk
		</h5>
		</div>
		</div>
		</div>
...
<a href="#">SUPPLIERS</a> <br/>
 ...
 <div class="span6">
<h5>Cửa hàng trang sức PNJ HP</h5>
Chuyên đề quản trị hệ thống mạng 1, linux, TDC, CD16TM1.<br>
Made by Nguyễn Tấn Phát via website hoanghait.tk.<br>
URL website " https://trangsuctanphat.tk ". <br>
Support  24/24<br>
 </div>
 </div>
</footer>
...
<span>Copyright &copy; 2019 PNJ HP<br>
	        Cửa hàng trang sức PNJ HP</span>
</div>
</div>
